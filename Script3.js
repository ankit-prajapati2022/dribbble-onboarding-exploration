(Dribbble.InfiniteScroll = {
  paginationContainerHTML:
    '<div class="loading-more"><span class="processing">Loading more\u2026</span></div>',
  ...
  jqueryLoadingIndicator: function (t, e) {
    ...
    return $.extend({}, new Dribbble.InfiniteScroll.genericLoadingIndicator(), {
      ...
      showReachedEnd: function () {
        n((e && e.text) || "You\u2019ve reached the end of the list"),
          e && e.cb && e.cb();
      },
      ...
      showThrottled: function (e) {
        i.html(
          '<div class="rate-limited"><a href="#" class="load-next-page">Load more\u2026</a> <span>You\u2019ve exceeded our rate limits, so you may need to wait a minute or so. <a href="https://help.dribbble.com/#rate-limits" target="_blank">(more info)</a><span></div>'
        ),
          i.find("a.load-next-page").on(
            "click",
            function (t) {
  ...
  horizontalScrollingIndicator: function (t) {
    return $.extend({}, new Dribbble.InfiniteScroll.genericLoadingIndicator(), {
      ...
      showThrottled: function (e) {
        this.hide(),
          t.append(
            '<li class="rate-limited"><a href="#" class="load-next-page">Load more\u2026</a> <span>You\u2019ve exceeded our rate limits, so you may need to wait a minute or so. <a href="https://help.dribbble.com/#rate-limits" target="_blank">(more info)</a><span></li>'
          ),
          t.find(".load-next-page").on(
            "click",
            function (t) {
              t.preventDefault(), this.retry(e);
            }.bind(this)
  ...
  (Dribbble.InfiniteScroll.Generic.prototype = {
    ...
    initialize: function (t) {
      ...
      (this.$el = $(t.$el)),
        (this.scrollable = this.scrollable || this.$el),
        Dribbble.Globals.throttle().then(
          function (t) {
            this.isScrolling = t(
              this.isScrolling.bind(this),
              this.throttleTime
            );
          }.bind(this)
        ),
        (this.loadingIndicator =
          this.loadingIndicator ||
          new Dribbble.InfiniteScroll.jqueryLoadingIndicator(
            this.loadingIndicatorSelector,
            { text: this.reachedEndText, cb: this.reachedEndFn }
          )),
    ...
    initAppendedResults: function () {
      this.blockDuplicates &&
        ((this.appendedResults = new Set()),
        $(this.itemSelector).each(
          function (t, e) {
    ...
    reset: function (t, e) {
      this.initAppendedResults();
      e = e || {};
      (this.baseUrl = t || this.baseUrl),
        (this.httpMethod = e.method || "GET"),
        (this.data = e.data),
        this.currentXhr && this.currentXhr.abort(),
        (this.reachedEnd = !1),
        (this.disabledNext = !1),
        (this.initiallyDisabled = !1),
        this.$el.empty(),
        (this.loaded = 0),
        this.resetPage(),
        this.setLoading(!1),
    ...
    onReady: function () {
      if (
        (this.unique && $(this.scrollable).off("scroll.infinite"),
        $(this.scrollable).on("scroll.infinite", this.isScrolling.bind(this)),
        this.deferredContentLoader)
      )
        return this.deferredContentLoader();
      var t = this.$el.find(this.itemSelector);
      if (this._noMoreItemsToLoad(t))
        return (this.reachedEnd = !0), void this.setLoading(!1);
      this.initiallyDisabled || (this.disabledNext = !1),
        this.autofill && this.fetchNextPageIfNeeded();
    },
    isScrolling: function () {
      var t = this.scrollPosition();
      if (
        (this.$el.toggleClass("is-scrolled", 0 < t),
        this.internalOnScroll && this.internalOnScroll(t),
        !this.reachedEnd)
      ) {
        this.onScroll && this.onScroll.apply(this, [t]);
        var e = t > this.lastPosition;
        (this.lastPosition = t),
          this.loading || (e && this.fetchNextPageIfNeeded(t));
      }
    },
    fetchNextPageIfNeeded: function (t) {
      this.initiallyDisabled ||
        ...
        this.distanceToEnd(t) > this.buffer ||
        this.fetchNextPage();
    },
    fetchNextPage: function (t) {
      if (!this.loading)
        return this.setLoading(!0), this.fetchPage(this.page.last + 1, t), !1;
    },
    fetchPage: function (t, i) {
      ...
      var n = function (t) {
          ...
          202 == this.currentXhr.status
            ? ((this.requestedShotCount = this._perPage()),
              (this.delay = (this.delay || 0) + 150),
              setTimeout(
                function () {
                  this.fetchPage();
                }.bind(this),
      ...
      this.data && (s.data = this.data),
        this.searchParams &&
          (s.data.search = JSON.stringify(this.searchParams)),
        (this.currentXhr = $.ajax(e, s));
    },
    append: function (t) {
      this.$el.append(t);
    },
    ...
    showNextPage: function (t) {
      ...
      if (
        (this.page.last++,
        this.jsonItems
          ? ((e = this.jsonItems(t)), this.append(t, this.page.last))
          : ((e = $(t).filter(this.itemSelector)),
            this.onBeforeAppend
              ? (e = this.onBeforeAppend(e))
            ...
            this.append(i || e, this.page.last),
            $("body").append($(t).filter("script")),
            Dribbble.MediaSwap &&
              new Dribbble.MediaSwap(
                "[data-video-teaser-small][data-video-teaser-large]"
              )),
        (this.loaded += e.length),
        this.emitAppendEvent(),
        this.appendedResults &&
          e.each(
            function (t, e) {
              this.appendedResults.add(e.getAttribute("data-id"));
        ...
        this.onAfterAppend && this.onAfterAppend(e),
        this.setLoading(!1),
        this._noMoreItemsToLoad(e))
      )
        (this.disabledNext = !0),
          (this.reachedEnd = !0),
          document.querySelector(this.itemSelector) &&
            this.loadingIndicator.showReachedEnd(),
          $(this.loadNextButtonSelector).hide();
      else if (this._reachedAutoPageLimit()) {
        (this.disabledNext = !0),
          $(this.loadNextButtonSelector).show(),
          this.nextButtonCanLoadMore &&
            !this.nextButtonCanLoadMore() &&
            (this.reachedEnd = !0),
          this.loadMoreCallback && this.loadMoreCallback(this);
      } else
        this.pageLoadCallback
          ? this.pageLoadCallback(this)
          : this.autofill && this.fetchNextPageIfNeeded();
    },
    emitAppendEvent: function () {
      var t = new Event("dribbble.infinitescroll.append", { bubbles: !0 });
    ...
    _reachedAutoPageLimit: function () {
      return (
        this.autoLoadPageLimit && this.page.last % this.autoLoadPageLimit == 0
      );
    },
    _noMoreItemsToLoad: function (t) {
      var e =
        (this.$el && this.$el[0]
          ? this.$el[0]
          : document.querySelector(".js-thumbnail-grid")
        ).children[0] !== t[0];
      return this.requestedShotCount && e
        ? t.length + 1 < this.requestedShotCount
        : this.requestedShotCount
        ? t.length < this.requestedShotCount
        : t.length < this._perPage();
    },
    _perPage: function () {
      return "function" == typeof this.perPage ? this.perPage() : this.perPage;
    },
    setLoading: function (t) {
      (this.loading = t) && $(this.loadNextButtonSelector).hide(),
        this.loadingIndicator[t ? "show" : "hide"]();
    },
    resetPage: function () {
      this.setPage(0);
    },
    setPage: function (t) {
      ...
      e && (t = parseInt(e[1], 10)), (this.page = { first: t, last: t });
    },
    showError: function (t) {
      if ("abort" != (t = t || {}).statusText) {
        if (403 == t.status || 429 == t.status)
          return (
            (this.loading = !1), void this.loadingIndicator.showThrottled(this)
          );
        404 == t.status
          ? this.loadingIndicator.showReachedEnd()
          : 401 == t.status
          ? this.loadingIndicator.showCustomEnd(t.responseText)
          : this.loadingIndicator.showErrorEncountered(t),
          (this.disabledNext = !0),
          (this.reachedEnd = !0),
          $(this.loadNextButtonSelector).hide();
      }
    ...
    queryParamsForPage: function (t) {
      var e = { page: t, per_page: this._perPage() };
    ...
    urlForPage: function (t) {
      ...
      return (
        $.extend(e, this.allowedParamsForPage()),
        -1 < i.indexOf("?") ? i + "&" + $.param(e) : i + "?" + $.param(e)
      );
    },
  }),
  ...
  (Dribbble.InfiniteScroll.Vertical.prototype = $.extend(
    {},
    Dribbble.InfiniteScroll.Generic.prototype,
    {
      ...
      scrollable: window,
      bindEventListeners: function () {
        Dribbble.InfiniteScroll.Generic.prototype.bindEventListeners.apply(
          this
        ),
          this.$backToTop &&
            this.$backToTop.on("click", function () {
              $("html,body").animate({ scrollTop: 0, display: "none" }, 500);
            });
      },
      ...
      internalOnScroll: function (t) {
        this.$backToTop &&
          !Dribbble.isMobile() &&
          (50 < t ? this.$backToTop.fadeIn(100) : this.$backToTop.fadeOut(100));
        var e = document.querySelector(".js-site-footer");
        e &&
          (t > e.offsetTop - window.innerHeight
            ? this.$backToTop.addClass("back-to-top-absolute")
            : this.$backToTop.removeClass("back-to-top-absolute"));
      },
  ...
  (Dribbble.InfiniteScroll.Horizontal.prototype = $.extend(
    {},
    Dribbble.InfiniteScroll.Generic.prototype,
    {
      initialize: function (t) {
        Dribbble.InfiniteScroll.Generic.prototype.initialize.apply(this, [t]),
          (this.buffer = Math.min(0.75 * this.$el.width(), 500)),
          $(this.scrollable).on(
            "click",
            ".scroll-backward a",
            this.scrollBackward.bind(this)
          ),
          $(this.scrollable).on(
            "click",
            ".scroll-forward a",
            this.scrollForward.bind(this)
          );
      },
      distanceToEnd: function (t) {
      ...
      scrollInDirection: function (t, e) {
        ...
        $(this.scrollable).animate(
          {
            scrollLeft:
              this.scrollPosition() + ($(this.scrollable).width() - i) * e,
          },
          800
        );
      },
  ...
  (Dribbble.InfiniteScroll.Vertical.Simple.prototype = $.extend(
    {},
    Dribbble.InfiniteScroll.Vertical.prototype,
    {
      initialize: function (t) {
        $(t.paginationContainerSelector || "div.page")
          .find(".pagination")
          .hide(),
          $(Dribbble.InfiniteScroll.paginationContainerHTML).insertAfter(t.$el);
        var e = $.extend({}, t, {
      ...
      function f(t, e, i) {
        ...
        if ("undefined" != typeof document) {
          if (1 < arguments.length) {
            if (
              "number" == typeof (i = p({ path: "/" }, f.defaults, i)).expires
            ) {
              var s = new Date();
          ...
          for (
            ...
            try {
              ...
              if (
                ((c = m.read
                  ? m.read(c, u)
                  : m(c, u) || c.replace(l, decodeURIComponent)),
                this.json)
              )
                try {
                  c = JSON.parse(c);
  ...
  (Dribbble.ShotOverlay = {
    ...
    $currentShotEl: function () {
      return (
        this.$el && this.$el.find("#screenshot-" + this.currentShotId).last()
      );
    },
    $next: function () {
      return (
        this.$currentShotEl() &&
        this.$currentShotEl().nextAll(this.shotElSelector).first()
      );
    },
    $prev: function () {
      return (
        this.$currentShotEl() &&
        this.$currentShotEl().prevAll(this.shotElSelector).first()
      );
    },
    init: function (t) {
      (t = t || {}),
        document.body.classList.contains("logged-out") &&
          (this.isRestictedNav = !0),
        (this.$nextButton = $(
          this.shotOverlay.querySelector(".shot-nav-next")
        )),
        (this.$prevButton = $(
          this.shotOverlay.querySelector(".shot-nav-prev")
        )),
        t.infiniteScroller && this.setInfiniteScroller(t.infiniteScroller),
        (this.isSimpleModal = t.isSimpleModal),
        (this.isDesignerSearchCard = t.isDesignerSearchCard),
        (this.isMinimalLayout = t.isMinimalLayout),
        (this.showSimilarShots = t.showSimilarShots),
        (this.originalUrl = t.originalUrl),
        (this.shotClickTargetSelector = t.shotClickTargetSelector),
        (this.shotElSelector = t.shotElSelector),
        (this.onTrigger = t.onTrigger || $.noop),
        this.bindEventListeners(),
        (this.active = !0);
    },
    setInfiniteScroller: function (t) {
      (this.infiniteScroller = t),
        this.infiniteScroller
          ? ((this.$el = this.infiniteScroller.$el),
            (this.infiniteScroller.onAfterAppend =
              this.addShotsToList.bind(this)))
          : (this.$el = null);
    },
    ...
    bindEventListeners: function () {
      (this.boundNextEvent = this.nextEvent.bind(this)),
        (this.boundPrevEvent = this.prevEvent.bind(this)),
        (this.boundClose = this.close.bind(this)),
        (this.boundOpenRelatedShot = this.openRelatedShot.bind(this)),
        (this.boundOpenMoreByShot = this.openMoreByShot.bind(this)),
        (this.boundHandleModalClick = this.handleModalClick.bind(this)),
        (this.$mobileHiddenElements = $("#wrap, .js-site-nav, #footer")),
        $(document.body).on(
          "click",
          this.shotClickTargetSelector,
          function (t) {
            if ((this.onTrigger && this.onTrigger(t), !this.ignoreClick(t)))
              return this.open($(t.currentTarget), !1, null), !1;
          }.bind(this)
        ),
        Dribbble.Hotkeys.map(
          "screenshots",
          {
            ESCAPE: function () {
          ...
          function () {
            return (
              !Dribbble.Attachments.overlayVisible() &&
              !Dribbble.Overlay.anyOpen()
            );
          }
        );
    },
    ...
    openMoreByShot: function (t) {
      if ((t.preventDefault(), this.ignoreClick(t) || !this.showSimilarShots))
    ...
    removeOpenEventListeners: function () {
      this.$nextButton.off("click", this.boundNextEvent),
        this.$prevButton.off("click", this.boundPrevEvent),
        this.closeOverlay.removeEventListener("click", this.boundClose),
        this.shotOverlay.removeEventListener(
          "click",
          this.boundHandleModalClick
        ),
        $(document.body).off(
          "click",
          ".rebound-title a, .more-thumbs li a, .js-similar-work .js-shot-link",
          this.boundOpenRelatedShot
        ),
        $(document.body).off(
          "click",
          ".js-more-by .js-shot-link",
          this.boundOpenMoreByShot
        );
    },
    addOpenEventListeners: function () {
      this.$nextButton.on("click", this.boundNextEvent),
        this.$prevButton.on("click", this.boundPrevEvent),
        this.closeOverlay.addEventListener("click", this.boundClose),
        this.shotOverlay.addEventListener("click", this.boundHandleModalClick),
        $(document.body).on(
          "click",
          ".rebound-title a, .more-thumbs li a, .js-similar-work .js-shot-link",
          this.boundOpenRelatedShot
    ...
    open: function (t, e, i) {
      ...
      this.scrollToId
        ? ((s["scroll-to-id"] = this.scrollToId), (this.scrollToId = null))
        : (document.querySelector(".js-overlay-content").scrollTop = 0),
        Dribbble.Router.pushState(s, null, n),
        i && i();
    },
    close: function () {
      (this.isOpen = !1),
        this.removeOpenEventListeners(),
        this.stepsToListPage() > window.history.length
          ? Dribbble.Router.pushState(null, null, this.originalUrl)
          : Dribbble.Router.go(-this.stepsToListPage());
    },
    show: function (t, e) {
      this.infiniteScroller && (this.infiniteScroller.autofill = !1),
        t.match(/shots\/(\d+)/) &&
          (this.currentShotId = t.match(/shots\/(\d+)/)[1]),
        Dribbble.EventBus.$emit("shot-overlay:show", {
          shotId: this.currentShotId,
        });
      var i = !1;
      (this.isDesignerSearchCard &&
        (i = (i ? i + "&" : "") + "isDesignerSearchCard=true"),
      this.isMinimalLayout && (i = (i ? i + "&" : "") + "isMinimalLayout=true"),
      this.showSimilarShots &&
        (i = (i ? i + "&" : "") + "showSimilarShots=true"),
      i && (t = t + "?" + i),
      this.hideNavArrows(),
      this.shotOverlay.classList.contains("lazyload") ||
        this.shotOverlay.classList.contains("lazyloading") ||
        this.shotOverlay.classList.contains("lazyloaded") ||
        this.shotOverlay.classList.add("lazyload"),
      (this.overlayContent.innerHTML = this.loadingTemplate().trim()),
      this.shotOverlay.classList.add("overlay-visible"),
      this.overlayContent.focus(),
      this.shotOverlay.classList.remove("overlay-hide"),
      $(".tipsy").remove(),
      Dribbble.HoverCards && Dribbble.HoverCards.dismiss(),
      Dribbble.isMobile())
        ? (this.overlayContent
            .querySelectorAll("[rel=tipsy]")
            .forEach(function (t) {
              t.setAttribute("original-title", "");
            }),
          (this.lastScrollPosition = window.pageYOffset),
          window.scrollTo(0, 0),
          this.$mobileHiddenElements.hide())
        : document.body.classList.add("noscroll");
      $.ajax(t, {
        dataType: "html",
        context: this,
        cache: !1,
        headers: { "X-Alt-Referer": e },
        success: function (t) {
          if (
            ((this.overlayContent.innerHTML = t),
            this.overlayContent
            ...
            User.loggedOut() && Dribbble.SignupModal.overlay.bindTrigger(),
            Dribbble.Hotkeys.TextAreaSubmission.fillShortcuts(),
            !this.isSimpleModal && this.shouldShowNav())
          ) {
            var e = this.$prev(),
              i = this.$next();
            i[0] ||
              !this.infiniteScroller ||
              this.infiniteScroller.reachedEnd ||
              ((this.infiniteScroller.disabledNext = !1),
              this.infiniteScroller.fetchNextPage()),
              e[0] && this.showPrevButton(e),
              i[0] && this.showNextButton(i);
          }
        },
      });
    },
    hide: function () {
      Dribbble.EventBus.$emit("shot-overlay:hide"),
        this.infiniteScroller && (this.infiniteScroller.autofill = !0),
        this.$mobileHiddenElements.show(),
        document.body.classList.remove("noscroll"),
        Dribbble.isMobile() && window.scrollTo(this.lastScrollPosition, 0),
        this.shotOverlay.classList.add("overlay-hide"),
        this.shotOverlay.classList.remove("overlay-visible"),
        setTimeout(
          function () {
            (this.overlayContent.innerHTML = ""),
              Dribbble.EventBus.$emit("shot-overlay:hidden");
          }.bind(this),
          400
        );
    },
    ...
    setNavLink: function (t, e, i) {
      return (
        Dribbble.EventBus.$emit("shot-overlay:navigate"),
        e
          ? (this.close(),
            Dribbble.SignupModal.open(t, { context: "shot-navigation" }))
  ...
  (Dribbble.Thumbnails = {
    ...
    initialize: function (t) {
      if (
        (t.showBoostedAds &&
          Dribbble.EventBus.$emit("infinite-thumbnails:initialized", {
        ...
        (this.gridClass = ".js-thumbnail-grid"),
        Dribbble.isHistorySupported() && document.querySelector(this.gridClass))
      ) {
        this.findElements(),
          (this.infiniteScroller = new Dribbble.InfiniteScroll.Vertical(
            this.scrollerOptions(t)
          )),
          t.enable_shot_overlay &&
            Dribbble.ShotOverlay.init({
              infiniteScroller: this.infiniteScroller,
              originalUrl: this.originalUrl,
              showSimilarShots: t.showSimilarShots,
              shotClickTargetSelector:
                ".js-thumbnail-grid:not(.selectable) .js-shot-link, .js-thumbnail-grid:not(.selectable) a.dribbble-over",
              shotElSelector: ".js-thumbnail",
            });
        var e = ".js-thumbnail-placeholder";
        Dribbble.AnimatedGifSwap &&
          Dribbble.AnimatedGifSwap.attach(".js-thumbnail-base.gif", {
    ...
    bindEventListeners: function () {
      this.loadNextButton.find(".load-more").on(
        "click",
        function () {
          (this.infiniteScroller.disabledNext = !1),
            this.infiniteScroller.fetchNextPage();
    ...
    onFetchPage: function (t, e) {
      Dribbble.Analytics.logDribbbleGAPageView(e),
        Dribbble.Itly && Dribbble.Itly.pageViewed({ url: e });
    },
    findElements: function () {
      var t = $("#main"),
        e = Dribbble && Dribbble.JsConfig && Dribbble.JsConfig.isRobot;
      (this.list = t.find(".js-thumbnail-grid")),
        (this.loadNextButton = t.find(".infinite:not(.previous)")),
        (this.footer = $(".secondary")),
        this.footer.is(":visible") || (this.footer = $("#footer")),
        e || t.find(".page").remove();
    },
    ...
    thumbnailsArray: function () {
      var t = document.querySelectorAll(".js-thumbnail-grid")[0],
        e = Array.prototype.slice.call(
          t.querySelectorAll(":scope > li[data-thumbnail-id]")
        ),
        i = t.children[0];
    ...
    thumbnailsToOmit: function () {
      return {
        exclude_shot_ids: this.thumbnailsArray()
          .map(function (t) {
      ...
      var e = {
        ...
        append: function (t, e) {
          ...
          (t = $.grep(t, function (t) {
            ...
            this.$el.append(t),
            Dribbble.DowngradeHiddenTracking &&
              (Dribbble.DowngradeHiddenTracking.removeEventListeners(),
              Dribbble.DowngradeHiddenTracking.bindEventListeners()),
            Dribbble.EventBus.$emit("infiniteScroll:appendedMore", {
              scrollPage: e,
            });
        },
      };
        ...
        t.deferredContent &&
          (e = $.extend(e, {
            ...
            extraParams: function (t) {
              var e = { cursor: Dribbble.Thumbnails.cursor, page: t };
...
var Screenshot = {
      ...
      Shot: {
        toggle: function (t) {
          function n(t) {
            a
              ? t
                  .addClass("current-user-likes highlighted")
                  .attr("href", t.data("unlikePath"))
              : t
                  .removeClass("current-user-likes highlighted")
                  .attr("href", t.data("likePath"));
          }
          function s() {
            if (u) {
          ...
          if (document.querySelector(".logged-in") && null !== r) {
            if (r.className.indexOf("processing")) {
              ...
              $.ajax({
                ...
                data: l,
                beforeSend: function () {
                  r.classList.add("processing"),
                    Dribbble.EventBus.$emit("shotLike:processing");
                },
                success: function (t) {
                  if (d) {
                    ...
                    $(e).replaceWith(t),
                      n(
                        $(".like-action-" + h + ".compact-true").find(
                          ".like-shot"
                        )
                      );
                  }
                  var i = Dribbble.Shots.get(h);
                  Dribbble.EventBus.$emit("shotLike:done", { isLike: a }),
                    Dribbble.Shots.logAnalyticsView(i.id),
                    Dribbble.Shots.logAnalyticsLike(i.id, {
    ...
    Flag: {
      ...
      flag: function () {
        ...
        return (
          confirm(
            "You are about to report this shot as abuse of Dribbble. Are you sure you wish to continue?"
          ) &&
            $.ajax({
              type: "POST",
              url: t,
              data: { screenshot_id: e, note: i },
              success: function (t) {
                $("#flag-section").html(t),
                  Dribbble.Itly.trackShotEvent({
                    eventName: "shotReported",
                    shotId: e,
                    additionalData: { description: i },
                  });
              },
            }),
          !1
      ...
      unflag: function () {
        ...
        return (
          $.ajax({
            type: "POST",
            url: this.href,
            data: { _method: "delete", screenshot_id: t },
            success: function (t) {
              $("#flag-section").html(t);
            },
          }),
    ...
    Shot: {
      twotimes: function () {
        if (
          window.matchMedia(
            "screen and (max-width: " + DEVICE_WIDTH_BREAKPOINT + ")"
          ).matches
        )
          return !1;
        var t = $(".main-shot"),
        ...
        if (t.hasClass(e))
          t.removeClass(e),
            !i &&
              n.find("picture").length &&
              (n.find("img").attr("src", n.find("img").attr("data-oldsrc")),
              n
                .find("source:not([media])")
                .attr(
                  "srcset",
                  n.find("source:not([media])").attr("data-oldsrc")
                ));
    ...
    Bucket: {
      open: function (t) {
        "true" !== t.target.contentEditable &&
          $("a[data-bucket-add]").trigger("click");
      },
    },
  },
  newLocation;
$(document.body).on("click", ".js-flag-link", Screenshot.Flag.showFlag),
  $(document.body).on("click", ".js-unflag-link", Screenshot.Flag.unflag),
  $(document.body).on("submit", ".js-flag-confirm", Screenshot.Flag.flag),
  $(document.body).on(
    "click",
  ...
  Dribbble.Hotkeys.map(
    ...
    function () {
      return (
        !Dribbble.Attachments.overlayVisible() && !Dribbble.Overlay.anyOpen()
      );
    }
  );
...
!(function (s) {
  s.fn.charCount = function (n) {
    function t(t) {
      var e = s(t).val().length,
        i = n.allowed - e;
      i <= n.warning && 0 <= i
        ? s(t).next().addClass(n.cssWarning)
        : s(t).next().removeClass(n.cssWarning),
        i < 0
          ? s(t).next().addClass(n.cssExceeded)
          : s(t).next().removeClass(n.cssExceeded),
        s(t)
          .next()
          .html(n.counterText + i);
    }
    var e = {
      allowed: 140,
      warning: 20,
  ...
  (Dribbble.Bucket.prototype = {
            ...
            $("<div />", { id: this.type + "-add", class: "lightbox" })
              ...
              .append(
                $("<div />", { class: "display" }).append(
                  $("<div />", { class: "processing", text: "Loading\u2026" })
                )
              )
          );
        var t = function () {
          ...
          e = function () {
            ...
            screenshotId &&
              ((url =
                "/shots/" +
                screenshotId +
                (t ? "/buckets_menu" : "/shots_thumbnail_buckets_menu")),
              $(this.activeTarget.parentElement).load(url, function (t) {
                if ($(t && $(t)[0])) {
                  var e = $(t)[0].text.trim();
    ...
    bindEventListeners: function () {
      ...
      $(this.options.parentTarget || document.body)
        .off(t)
        .on(t, this.target, this.show.bind(this)),
        this.overlay.$el
          .on("keyup", this.navigate.bind(this))
          .on("click", ".create form .cancel", this.hideCreate.bind(this))
          .on("submit", ".create form", this.create.bind(this))
          .on("click", ".add a.create", this.showCreate.bind(this))
          .on("click", "ol li a", this.toggleClicked.bind(this))
          .on("keyup", "#bucket_query", this.search.bind(this))
          .on("submit", "#bucket_search", function () {
            return !1;
          })
        ...
        $.ajax(
          {
            ...
            statusCode: {
              201: function (t) {
                i.find("#bucket_name").length &&
                  Dribbble.Itly.collectionCreated({
              ...
              422: function (t) {
                if (-1 < t.getResponseHeader("content-type").indexOf("json")) {
                  ...
                  this.overlay.find(".create-good").html(t.responseText),
                    $("#json-field").length ||
                      this.overlay
                        .find(".create-good form")
                        .append(
                          $("<input>", {
                            id: "json-field",
                            type: "hidden",
      ...
      if (e.is(":visible")) {
        switch (t.which) {
          case 13:
            "project" == this.type &&
            this.current &&
            this.current.hasClass("bucketed")
              ? this.overlay.find("#bucket_form").trigger("submit")
          ...
          case 40:
            ...
            this.select(i, { scrollIntoView: !0 });
        }
        return !1;
      }
    },
    ...
    refresh: function (e) {
      var i = this,
        t = this.activeTarget.dataset.listUrl
          ? this.activeTarget.dataset.listUrl
          : this.activeTarget.href;
      this.accountId &&
        (t = Dribbble.Url.addParams(t, { account_id: this.accountId })),
        (e = e || {}),
        this.overlay.find(".display").load(t, function () {
          if (i.hasItems())
            if ((i.showAdd(), e.id)) {
              var t = "#" + i.type + "-" + e.id;
          ...
          i.overlay.$el.find("ol.group").on("scroll", function () {
            clearTimeout(i.scrolling),
              (i.scrolling = setTimeout(function () {
                i.scrolling = !1;
              }, 250));
          });
        });
    ...
    search: function (t) {
      ...
      this.overlay
        ...
        .each(function () {
          var t = $(this);
          -1 < t.find("a strong").text().toLowerCase().search(o)
            ? t.show()
            : t.hide();
        })
        .sort(function (t, e) {
        ...
        .appendTo(this.overlay.find("ol.group")),
        this.select(this.overlay.find("ol.group li:visible").eq(0));
    },
    select: function (t, e) {
      var i = $(t);
      return (
        0 == i.length ||
          ...
          e && e.scrollIntoView && i.get(0).scrollIntoView(!1)),
        !1
      );
    },
    show: function (t) {
      return (
        t.preventDefault(),
        (this.activeTarget =
          "A" == t.target.tagName ? t.target : t.target.closest("a")),
        this.refresh(),
        this.overlay.show(),
        Dribbble.isMobileSafari() || $("body").addClass("noscroll"),
        !1
      );
    },
    showAdd: function () {
      this.overlay
        ...
        .show()
        .end()
        .find(".create-bucket, .create-good")
        .hide()
        .end(),
      ...
      if ("good" == this.type)
        $("#json-field").length ||
          ...
          this.overlay
            ...
            .show()
            .end(),
          this.overlay.find("#good_title").trigger("focus");
      else {
        this.overlay
          .find(".add")
          .hide()
        ...
        t.next().hasClass("counter") ||
          t.charCount({ allowed: 64, warning: 10 }),
          e.next().hasClass("counter") || e.charCount({ allowed: 160 }),
    ...
    toggle: function (t) {
      ...
      if ("bucket" == this.type) {
        ...
        e.hasClass("bucketed")
          ? $.ajax(i + "/" + e.modelId(), { type: "DELETE", success: n })
          : $.post(i, {
              bucket_id: e.modelId(),
              ...
              .fail(s),
          e.toggleClass("bucketed");
      } else if ("good" == this.type)
        $("ol.goods li.included").removeClass("included"),
          e.addClass("included"),
          this.overlay.find("input[name=good_id]").val(e.modelId()),
          this.overlay.find(".add form button.form-sub").attr("disabled", !1);
      else {
        t = ".bucketed:not(.team)";
        var r = this.overlay.find("#bucket_form");
        e.hasClass("team") && (t = ".bucketed.team"),
          e.addClass("bucketed"),
          e.siblings(t).addClass("unbucketed").removeClass("bucketed"),
          r.find("input[data-user-id=" + e.data("user-id") + "]").remove(),
          (input = $("<input>", {
            type: "hidden",
            name: "bucket_id[]",
      ...
      return (
        o.contains("bucketed") || o.contains("included")
          ? (this.selected = { id: e.modelId(), title: e.data("title") })
          : (this.selected = {}),
        !1
      );
    },
  ...
  (function ($) {
    ($.fn.editable = function (t, e) {
      if ("disable" != t)
        if ("enable" != t) {
          if ("destroy" != t) {
            var h = $.extend({}, $.fn.editable.defaults, { target: t }, e),
              d = $.editable.types[h.type].plugin || function () {},
              c = $.editable.types[h.type].submit || function () {},
              u =
                $.editable.types[h.type].buttons ||
                $.editable.types.defaults.buttons,
              b =
                $.editable.types[h.type].content ||
                $.editable.types.defaults.content,
              m =
                $.editable.types[h.type].element ||
                $.editable.types.defaults.element,
              f =
                $.editable.types[h.type].reset ||
              ...
              y = h.onerror || f;
            return (
              h.tooltip && $(this).attr("title", h.tooltip),
              (h.autowidth = "auto" == h.width),
              (h.autoheight = "auto" == h.height),
              this.each(function () {
                var a = this,
                  n = $(a).width(),
                  l = $(a).height();
                $(this).data("event.editable", h.event),
                  $.trim($(this).html()) || $(this).html(h.placeholder),
                  $(this).on(h.event, function (t) {
                    if (
                      ...
                      t.preventDefault(),
                        t.stopPropagation(),
                        h.tooltip && $(a).removeAttr("title"),
                        0 == $(a).width()
                          ? ((h.width = n), (h.height = l))
                          : ("none" != h.width &&
                              (h.width = h.autowidth ? $(a).width() : h.width),
                            "none" != h.height &&
                              (h.height = h.autoheight
                                ? $(a).height()
                                : h.height)),
                        $(this).html().toLowerCase().replace(/(;|")/g, "") ==
                          h.placeholder.toLowerCase().replace(/(;|")/g, "") &&
                          $(this).html(""),
                        (a.editing = !0),
                        (a.revert = $(a).html()),
                        $(a).html("");
                      ...
                      h.cssclass &&
                        ("inherit" == h.cssclass
                          ...
                          : s.attr("class", h.cssclass)),
                        h.style &&
                          ("inherit" == h.style
                            ? (s.attr("style", $(a).attr("style")),
                              s.css("display", $(a).css("display")))
                            : s.attr("style", h.style));
                      var e,
                        r = m.apply(s, [h, a]);
                      if (h.loadurl) {
                        var o = setTimeout(function () {
                          ...
                          i = {};
                        null != h.id && (i[h.id] = a.id),
                          $.isFunction(h.loaddata)
                            ? $.extend(i, h.loaddata.apply(a, [a.revert, h]))
                            : $.extend(i, h.loaddata),
                          $.ajax({
                            type: h.loadtype,
                            url: h.loadurl,
                      ...
                      b.apply(s, [e, h, a]),
                        ...
                        $(a).append(s),
                        d.apply(s, [h, a]),
                        $(":input:visible:enabled:first", s).focus(),
                        h.select && r.select(),
                        r.keydown(function (t) {
                          27 == t.keyCode &&
                            (t.preventDefault(), f.apply(s, [h, a]));
                        }),
                        "cancel" == h.onblur
                          ? r.blur(function () {
                        ...
                        s.submit(function (t) {
                          if (
                            ...
                            if ($.isFunction(h.target)) {
                              ...
                              $(a).html(e),
                                (a.editing = !1),
                                p.apply(a, [a.innerHTML, h]),
                                $.trim($(a).html()) || $(a).html(h.placeholder);
                            } else {
                              var i = {};
                              (i[h.name] = r.val()),
                                null != h.id && (i[h.id] = a.id),
                                $.isFunction(h.submitdata)
                                  ? $.extend(
                                      i,
                                      h.submitdata.apply(a, [a.revert, h])
                                    )
                                  : $.extend(i, h.submitdata),
                                "PUT" == h.method && (i._method = "put"),
                                $(a).html(h.indicator);
                              var n = {
                                type: "POST",
                                data: i,
                                ...
                                url: h.target,
                                success: function (t) {
                                  "html" == n.dataType && $(a).html(t),
                                    (a.editing = !1),
                                    p.apply(a, [t, h]),
                                    $.trim($(a).html()) ||
                                      $(a).html(h.placeholder);
                                },
                                error: function (t) {
                                  y.apply(s, [h, a, t]);
                                },
                  ...
                  (this.reset = function (t) {
                    this.editing &&
                      ...
                      (a.editing = !1),
                      $.trim($(a).html()) || $(a).html(h.placeholder),
                      h.tooltip && $(a).attr("title", h.tooltip));
                  });
              })
            );
          }
        ...
        types: {
                ...
                $(this).append(s),
                  $(s).click(function () {
                    if ($.isFunction($.editable.types[e.type].reset))
                      var t = $.editable.types[e.type].reset;
          ...
          text: {
            element: function (t) {
              var e = $("<input />");
              return (
                "none" != t.width && e.width(t.width),
                "none" != t.height && e.height(t.height),
  ...
  (Dribbble.imageOnLoad = function (t, e) {
    function i(t, e) {
      var i;
      return function () {
...
(Dribbble.JsConfig = Dribbble.JsConfig || {}),
  (Dribbble.VideoPlayer = (function () {
    var s = function (t, e) {
      ...
      t = function (t) {
        (this.videos = document.querySelectorAll(t)),
          this.videos.forEach(function (e) {
            (container = e.parentElement),
              (controls = container.querySelector(".video-controls")),
              (hasAudio = "true" != e.dataset.silent),
              (muteControls = controls.querySelector(".mute-controls")),
              (e.muteControls = muteControls),
              (muteControls.className = "mute-controls mute-mute"),
              (e.muted = !0);
            var i = 0,
              t = function () {
                var t = e.dataset;
                e.offsetWidth < 400 && 400 < i && t.videoSmall
                  ? ((e.src = t.videoSmall), (i = 400))
                  : e.offsetWidth < 800 &&
                    (800 < i || i <= 400) &&
                    t.videoMedium
                  ? ((e.src = t.videoMedium), (i = 800))
                  : t.videoLarge && i <= 800
                  ? ((e.src = t.videoLarge), (i = 801))
                  : t.src && !e.src && (e.src = t.src);
              },
              n = s(t, 250);
            window.addEventListener("resize", n),
              ...
              Dribbble.isMobile() &&
                ...
                muteControls.children.length &&
                  Array.prototype.forEach.call(
                    muteControls.children,
                    function (t) {
                      t.removeAttribute("rel"),
                        t.removeAttribute("original-title");
                    }
                  )),
              hasAudio
                ? muteControls.addEventListener("click", r.togglemute(e))
                : (controls.style.display = "none"),
              e.autoplay ||
                (e.addEventListener("mouseenter", r.play(e)),
                e.addEventListener("mouseleave", r.pause(e)),
                controls.addEventListener("mouseenter", r.play(e)),
                controls.addEventListener("mouseleave", r.pause(e))),
              e.dataset.shotUrl && e.addEventListener("click", r.clicked(e));
          });
      },
      r = {
        togglemute: function (t) {
          return function () {
            (t.muteControls.className = t.muted
              ? "mute-controls mute-unmute"
              : "mute-controls mute-mute"),
              (t.muted = !t.muted);
          };
        },
        play: function (t) {
  ...
  (Dribbble.FullScreenViewer = {
    initialize: function () {
      (this.fullScreenHeader = document.querySelector(".full-screen-header")),
        (this.thumbnails = this.fullScreenHeader.querySelector(
          ".header-thumbnails ul"
        )),
        (this.mainViewer = document.querySelector(".full-screen-main")),
        (this.viewerMedia = this.mainViewer.querySelector("img, video")),
        this.mainViewer && this.viewerMedia
          ? ((this.viewerSelectorKind = this.viewerMedia.tagName.toLowerCase()),
            this.setupViewer(),
            ...
            this.bindEventListeners())
          : console.error(
              "Could not find a media item inside the main viewer."
            );
    },
    setupViewer: function () {
      var t = this;
      if (
        ((this.ViewerWidth = this.mainViewer.clientWidth),
        this.mainViewer.classList.add("loading"),
        "video" === this.viewerSelectorKind)
      )
        (t.viewerMedia.onloadeddata = function () {
          (t.mediaWidth = t.viewerMedia.videoWidth),
            t.mainViewer.classList.remove("loading"),
            t.mainViewer.querySelector(".video-controls").classList.add("show");
        }),
          new Dribbble.VideoPlayer("video");
      else if ("img" === this.viewerSelectorKind) {
        var e = function () {
          t.mainViewer.classList.remove("loading"),
            (t.mediaWidth = t.viewerMedia.naturalWidth),
            t.shouldZoom();
        };
    ...
    handleHeaderClasses: function () {
      this.thumbnails &&
        (this.fullScreenHeader.clientWidth === this.thumbnails.clientWidth
          ? this.fullScreenHeader.classList.add("is-full")
          : this.fullScreenHeader.classList.remove("is-full"));
    },
    checkThumbnailsScroll: function () {
      this.thumbnails &&
        ((this.thumbnailScrollable = !1),
        (this.thumbnailsWidth = this.thumbnails.offsetWidth),
        (this.thumbnailsScrollWidth = this.thumbnails.scrollWidth),
        this.thumbnailsScrollWidth > this.thumbnailsWidth
          ? ((this.thumbnailScrollable = !0),
            this.thumbnails.classList.add("scrollable"))
          : ((this.thumbnailScrollable = !1),
            this.thumbnails.classList.remove("scrollable")),
        this.updateScrollIndicators(),
        this.thumbnailScrollable &&
          !this.hasScrollEvent &&
    ...
    shouldZoom: function () {
      (this.canZoom = this.mediaWidth > this.ViewerWidth),
        "img" === this.viewerSelectorKind &&
          (this.canZoom
            ? this.mainViewer.classList.add("can-zoom")
            : this.mainViewer.classList.remove("can-zoom"));
    },
    bindEventListeners: function () {
      window.addEventListener("resize", this.handleResize.bind(this)),
        "img" === this.viewerSelectorKind &&
          this.viewerMedia.addEventListener(
            "click",
            function () {
              this.canZoom &&
                (this.mainViewer.classList.toggle("zoomed"),
                this.viewerMedia.classList.toggle("zoomed"));
            }.bind(this)
          );
    },
    updateScrollIndicators: function () {
      ...
      e
        ? this.thumbnails.classList.add("scrolled-left")
        : this.thumbnails.classList.remove("scrolled-left"),
        i
          ? this.thumbnails.classList.remove("scrolled-right")
          : this.thumbnails.classList.add("scrolled-right");
    },
  ...
  (Dribbble.Attachments = {
      ...
      this.overlay.length &&
        ...
        $.ajax(t, {
          ...
          success: function (t) {
            e.overlay.html(t),
              Dribbble.isMobile()
                ? $(".shot-overlay").is(":visible")
                  ? ($(".shot-overlay").hide(), (e.inShotOverlay = !0))
                  : $(".js-site-nav, #wrap, #footer").hide()
                : $("body, .shot-overlay").addClass("attachment-noscroll"),
              e.overlay.trigger("focus"),
    ...
    hideOverlay: function () {
      Dribbble.isMobile()
        ? this.inShotOverlay
          ? $(".shot-overlay").show()
          : $(".js-site-nav, #wrap, #footer").show()
        : $("body, .shot-overlay").removeClass("attachment-noscroll"),
  ...
  $(".attachment-overlay").length &&
    Dribbble.isHistorySupported() &&
    Dribbble.Attachments.initialize(),
  (Dribbble.ShotFeed = {
    initialize: function () {
    ...
    updateSignupContext: function () {
      ...
      (void 0 === t && void 0 === e) ||
        (document
          .getElementsByClassName("bucket-shot")[0]
          .setAttribute("data-context", "shot-page-feed"),
        document
          .getElementsByClassName("like-shot")[0]
          .setAttribute("data-context", "shot-page-feed"),
        document
          .getElementsByClassName("follow")[0]
          .setAttribute("data-context", "shot-page-feed"));
    },
  }),
  (function (a, l) {
    ...
    function h(t) {
      (this.time = t.time),
        ...
        (this.intersectionRect = t.intersectionRect || r()),
    ...
    function c(t, e) {
      ...
      return (
        0 <= o &&
        0 <= a && { top: i, bottom: n, left: s, right: r, width: o, height: a }
      );
    }
    function u(t) {
      var e;
    ...
    if (
      ...
      "IntersectionObserverEntry" in a &&
      "intersectionRatio" in a.IntersectionObserverEntry.prototype
    )
      ...
      (t.prototype.THROTTLE_TIMEOUT = 100),
        ...
        (t.prototype._monitorIntersections = function () {
          this._monitoringIntersections ||
            ...
            this.POLL_INTERVAL
              ...
              : (e(a, "resize", this._checkForIntersections, !0),
                e(l, "scroll", this._checkForIntersections, !0),
        ...
        (t.prototype._unmonitorIntersections = function () {
          this._monitoringIntersections &&
            ...
            i(a, "resize", this._checkForIntersections, !0),
            i(l, "scroll", this._checkForIntersections, !0),
            this._domObserver &&
        ...
        (t.prototype._checkForIntersections = function () {
          ...
          this._observationTargets.forEach(function (t) {
            ...
            s
              ? a && n
                ? this._hasCrossedThreshold(s, o) && this._queuedEntries.push(o)
                : s && s.isIntersecting && this._queuedEntries.push(o)
              : this._queuedEntries.push(o);
          }, this),
        ...
        (a.IntersectionObserver = t),
        (a.IntersectionObserverEntry = h);
    }
  })(window, document),
  Dribbble.Media || (Dribbble.Media = {}),
  (Dribbble.Media.Load = function (t, e) {
    if (
      ((this.mediaContainer = t),
      (this.loadedCallback = e || null),
      (this.mediaType = null) === this.mediaContainer &&
        this.mediaContainer.dataset.lazy)
    )
      throw new Error("Something wrong with the mediaElement");
    if (
      ((this.imageElement = this.mediaContainer.querySelector("img")),
      (this.videoElement = this.mediaContainer.querySelector("video")),
      this.imageElement && (this.mediaType = "image"),
      this.videoElement && (this.mediaType = "video"),
      !this.mediaType)
    )
      throw new Error("Could not find images or videos inside mediaElement");
    this.replaceSource();
  }),
  (Dribbble.Media.Load.prototype = {
    replaceSource: function () {
      this.mediaContainer
        .querySelectorAll("source, img, video")
        .forEach(function (t) {
          var e = t.dataset.srcset || null,
            i = t.dataset.src || null;
          e && (t.setAttribute("srcset", e), t.removeAttribute("data-srcset")),
            i && (t.setAttribute("src", i), t.removeAttribute("data-src"));
        }),
      ...
      if ("image" === this.mediaType) {
        var e = function () {
          t.mediaContainer.removeAttribute("data-lazy"),
            t.loadedCallback && t.loadedCallback(t.mediaContainer);
        };
  ...
  (Dribbble.Carousel.prototype = {
    ...
    updateFromBreakpoint: function () {
      ...
      for (var e in this.breakpoints)
        window.innerWidth >= e && (this.activeBreakpoint = e);
      (this.activeBreakpoint =
        ...
        t !== this.activeBreakpoint &&
          (null !== t && null === this.activeBreakpoint
            ? this.updateOptions()
            : this.updateOptions(this.breakpoints[this.activeBreakpoint]));
    },
    updateOptions: function (t) {
      var e = t || {};
      for (var i in (this.defaultSet ||
        ((this.defaultAllowedOptions = {
        ...
        (this.defaultSet = !0)),
      this.defaultAllowedOptions))
        this[i] = e.hasOwnProperty(i) ? e[i] : this.defaultAllowedOptions[i];
      this.eventsBinded &&
        (this.draggable ? this.bindDragEvent() : this.removeDragEvents());
    },
    initialize: function () {
      this.bindEventListeners(),
  ...
  (Dribbble.MediaGallery = {
    ...
    shouldScrollThumbnails: function (t) {
      if (!0 === this.thumbnailScrollable) {
        ...
        a < 0 &&
          $(this.galleryThumbnailsContainer)
            .stop(!0, !0)
            .animate({ scrollLeft: a + (h - r) }, 200),
          l + i > this.thumbnailsContainerWidth &&
            $(this.galleryThumbnailsContainer)
              .stop(!0, !0)
              .animate(
                {
    ...
    checkScroll: function () {
      (this.thumbnailScrollable = !1),
        (this.thumbnailsContainerWidth =
          this.galleryThumbnailsContainer.offsetWidth),
        (this.thumbnailsContainerScrollWidth =
          this.galleryThumbnailsContainer.scrollWidth),
        this.thumbnailsContainerScrollWidth > this.thumbnailsContainerWidth
          ? ((this.thumbnailScrollable = !0),
            this.galleryThumbnailsContainer.classList.add("scrollable"))
          : ((this.thumbnailScrollable = !1),
            this.galleryThumbnailsContainer.classList.remove("scrollable")),
        this.updateScrollIndicators(),
        this.thumbnailScrollable &&
          !this.hasScrollEvent &&
          (Dribbble.Globals.debounce().then(
    ...
    updateScrollIndicators: function () {
      var t = this.mediaContainer.querySelector(".scroll-backward"),
        ...
        n = 0 < i,
        s =
          i + this.thumbnailsContainerWidth >=
          this.thumbnailsContainerScrollWidth;
      n ? t.classList.add("visible") : t.classList.remove("visible"),
        s ? e.classList.remove("visible") : e.classList.add("visible");
    },
    handleThumbnailsScroll: function () {
      this.updateScrollIndicators();
    },
  ...
  (Dribbble.LargeShotViewRecorder = {
    start: function () {
      ...
      $(window).off("scroll.largeShotViewRecorder"),
        ...
        setTimeout(this.considerShotsViewed.bind(this), 1e3);
    },
